...
namespace SmartApp.Application.Service
{
    public interface IEmailNotification
    {
        ...
        Task<Response> SendCheckInEmailAsync(DiningTableWithTimeSlotModel model);
    }
    public class EmailNotification : IEmailNotification
    {
        ...
        public async Task<Response> SendCheckInEmailAsync(DiningTableWithTimeSlotModel model)
        {
        ...
        private string GetCheckInEmailBody(string firstName, string lastName, RestaurantReservationDetails reservationDetails)
        {
            return $$"""
                    ...
                    <body>
                        ...
                        <p>Warm regards,</p>
                        <p>Yummy<br>{{reservationDetails.RestaurantName}}<br>Have nice Day</p>
                    </body>
                    </html>
        ...
        private string GetBookingEmailBody(ReservationModel model, RestaurantReservationDetails reservationDetails, bool isReminderEmail)
        {
            ...
            return $$"""
                    ...
                    <body>
                        ...
                        <p>Yummy<br>{{reservationDetails.RestaurantName}}<br>Have a nice day</p>
                    </body>
                    </html>                    
                    """;
        }
